...
REPREPRO_COMMAND="./reprepro-untangle.sh -V -b ${REPREPRO_BASE_DIR} ${ARCHITECTURE} ${COMPONENT} ${TYPE}"
REPREPRO_BASE_COMMAND="$PKGTOOLS/${REPREPRO_COMMAND}"
REPREPRO_REMOTE_BASE_COMMAND="$PKGTOOLS/reprepro-untangle.sh -V -b ${REPREPRO_BASE_DIR} ${ARCHITECTURE} ${COMPONENT} ${TYPE}"
