...
class GerritAPI(RepoAPI):
    """Gerrit API implementation."""
    ...
    def create_pr(
        ...
        Args:
            repository: Repository name
            branch_to: Target branch
            new_branch: Source branch for the PR (unused in Gerrit)
            branch_from: Source branch
    ...
    def create_branch(
        ...
        """
        Create a new branch in Gerrit.
        
        Note: For Gerrit, we don't create temporary branches the same way as GitHub.
        ...
        Returns:
            Tuple of (None, None) - not implemented for Gerrit
        """
