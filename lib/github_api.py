...
from lib.repo_api import RepoAPI
...
class GitHubAPI(RepoAPI):
    ...
    def create_pr(self, repository: str, branch_to: str, new_branch: str, branch_from: str) -> Tuple[Optional[int], str]:
        """
    ...
    def create_branch(self, repository: str, branch_from: str, branch_to: str) -> Tuple[Optional[int], Optional[str]]:
        """
        ...
        sha = self.get_branch_revision(repository, branch_from)
