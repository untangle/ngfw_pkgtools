...
[ -n "$EMAIL" ] && mutt -F $MUTT_CONF_FILE -s "[$REPOSITORY] $FROM_DISTRIBUTION promoted to $TO_DISTRIBUTION" -a ${tmp_base}.txt -a ${tmp_base}.csv $RECIPIENT <<EOF
Effective `date`.
