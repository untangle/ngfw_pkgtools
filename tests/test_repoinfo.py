...
class TestRepositoryInfo:
    ...
    def test_repository_info_git_url_construction(self):
        ...
        repo = repoinfo.RepositoryInfo(
            name="test-repo", git_base_url="git@github.com:untangle", versioned_resources=[]
        )
...
class TestListRepositories:
    ...
    def sample_yaml_file(self):
        ...
        yaml_content = {
            ...
            "repositories": {
                "test-repo-1": {"git_source": "gerrit", "products": {"mfw": None, "velo": None}},
                "test-repo-2": {"private": True, "products": {"ngfw": {"default_branch": "main"}}},
                "test-repo-3": {
                    "git_base_url": "git@github.com:custom",
                    "products": {"mfw": None},
                },
                "obsolete-repo": {"obsolete": True, "products": {"mfw": None}},
            },
        }
    ...
    def test_obsolete_repositories_included_when_requested(self, sample_yaml_file):
        ...
        repos = repoinfo.list_repositories(
            "mfw", yaml_file=sample_yaml_file, include_obsolete=True
        )
...
class TestRemoteRepositoryExistence:
    ...
    def test_velo_gerrit_repositories_exist(self, actual_yaml_file):
        ...
        assert not failures, "Failed to access repositories:\n" + "\n".join(failures)
