...
[ -n "$WIPE_OUT_TARGET" ] && ${PKGTOOLS}/remove-packages-bucket.sh $EXTRA_ARGS -r $REPOSITORY -d $TARGET_DISTRIBUTION

${PKGTOOLS}/copy-packages-bucket.sh $EXTRA_ARGS -r $REPOSITORY $FROM_DISTRIBUTION $TARGET_DISTRIBUTION
